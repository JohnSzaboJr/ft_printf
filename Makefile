...
C_FILES = ft_strcpy.c ft_strchr.c ft_putchar.c ft_putnbr.c ft_memset.c ft_putstr.c ft_strlen.c ft_isdigit.c ft_atoi.c ft_bzero.c ft_strncpy.c ft_strstr.c ft_strcmp.c \
ft_strncmp.c \
ft_strcat.c \
ft_strncat.c \
ft_tolower.c \
